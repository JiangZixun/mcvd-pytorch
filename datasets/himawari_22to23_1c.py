...
class Xiaoshan_6steps_30min_Test_Dataset_1C(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 取最后一个红外通道
        tensor = torch.tensor(data, dtype=torch.float32).contiguous()[:, -2:-1, ...] # T 1 H W
...
class Xiaoshan_6steps_30min_Dataset_1C(Dataset):
